                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6">
                            ...
                            <div class="col-sm-4 control-block">
                                <asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Price Required" Display="Dynamic" ControlToValidate="txtPrice" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group col-sm-6 col-md-6">
                        ...
                        <div class="form-group col-sm-6 col-md-6">
                            ...
                            <div class="col-sm-4 control-block">
                                <asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator7" runat="server" ErrorMessage="ValidFrom Required" Display="Dynamic" ControlToValidate="txtValidFrom" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group col-sm-6 col-md-6">
                            ...
                            <div class="col-sm-4 control-block">
                                <asp:RequiredFieldValidator CssClass="err-block" ID="RequiredFieldValidator8" runat="server" ErrorMessage="ValidTo Required" Display="Dynamic" ControlToValidate="txtValidTo" ValidationGroup="ValidationGroup" ForeColor="Red" Text="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
