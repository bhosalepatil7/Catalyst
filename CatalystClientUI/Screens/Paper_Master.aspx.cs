...
namespace CatalystClientUI
{
    public partial class Paper_Master : System.Web.UI.Page
    {
        ...
        protected void grdSubjectMaster_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            if (ddlDiscount.Items.FindByValue(((Label)grid.FindControl("lblDiscountID")).Text) != null)
            ...
            if (ddlCurrency.Items.FindByValue(((Label)grid.FindControl("lblCurrencyID")).Text) != null)
            ...
            if (DateTime.TryParseExact(((Label)grid.FindControl("lblValidTo")).Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out dt1))
                txtValidTo.Text = dt1.ToString("dd/MM/yyyy");
        }
