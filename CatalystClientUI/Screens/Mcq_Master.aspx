                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-3">
                            ...
                            <div class="col-sm-1 control-block">
                                ...
                                <asp:RegularExpressionValidator CssClass="err-block err-bottom" ID="RegularExpressionValidator9" runat="server" ErrorMessage="Invalid Time" Display="Dynamic" ControlToValidate="txtTime" ValidationGroup="ValidationGroup" ForeColor="Red" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                            </div>
                        </div>
                        <div class="form-group col-sm-6 col-md-3">
